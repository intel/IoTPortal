(self["webpackChunk"] = self["webpackChunk"] || []).push([["resources_js_views_deviceJobs_ListDeviceJobs_js"],{

/***/ "./resources/js/components/DataTableDateRangeFilter/DataTableDateRangeFilter.js":
/*!**************************************************************************************!*\
  !*** ./resources/js/components/DataTableDateRangeFilter/DataTableDateRangeFilter.js ***!
  \**************************************************************************************/
...
var DataTableDateRangeFilter = function DataTableDateRangeFilter(_ref) {
  var value = _ref.value,
      setValueCallback = _ref.setValueCallback,
      dataTable = _ref.dataTable,
      filterField = _ref.filterField,
      filterMatchMode = _ref.filterMatchMode;

  var onChange = function onChange(event) {
    if (event.value !== null && event.value[0] !== null && event.value[1] !== null) dataTable.current.filter((0,_utils_utils__WEBPACK_IMPORTED_MODULE_2__.formatDateTimeRangeToCommonString)(event.value), filterField, filterMatchMode);else if (event.value === null) dataTable.current.filter(null, filterField, filterMatchMode);
    setValueCallback(event.value);
  };

  return /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_3__.jsx)(primereact_calendar__WEBPACK_IMPORTED_MODULE_1__.Calendar, {
    selectionMode: "range",
    value: value,
    onChange: onChange,
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (DataTableDateRangeFilter);
...
/***/ "./resources/js/components/DeleteDeviceJobsModal/DeleteDeviceJobsModal.js":
/*!********************************************************************************!*\
  !*** ./resources/js/components/DeleteDeviceJobsModal/DeleteDeviceJobsModal.js ***!
  \********************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
var DeleteDeviceJobsModal = function DeleteDeviceJobsModal(_ref) {
  var show = _ref.show,
      onClose = _ref.onClose,
      onConfirm = _ref.onConfirm;
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (DeleteDeviceJobsModal);
...
/***/ "./resources/js/components/DeviceJobsDataTable/DeviceJobsDataTable.js":
/*!****************************************************************************!*\
  !*** ./resources/js/components/DeviceJobsDataTable/DeviceJobsDataTable.js ***!
  \****************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony import */ var primereact_dropdown__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! primereact/dropdown */ "./node_modules/primereact/dropdown.js");
...
/* harmony import */ var _components_DataTableHeader_DataTableHeader__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ../../components/DataTableHeader/DataTableHeader */ "./resources/js/components/DataTableHeader/DataTableHeader.js");
/* harmony import */ var _DataTableDateRangeFilter_DataTableDateRangeFilter__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ../DataTableDateRangeFilter/DataTableDateRangeFilter */ "./resources/js/components/DataTableDateRangeFilter/DataTableDateRangeFilter.js");
/* harmony import */ var _DeleteDeviceJobModal_DeleteDeviceJobModal__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ../DeleteDeviceJobModal/DeleteDeviceJobModal */ "./resources/js/components/DeleteDeviceJobModal/DeleteDeviceJobModal.js");
/* harmony import */ var _DeviceJobStatusIndicator_DeviceJobStatusIndicator__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ../DeviceJobStatusIndicator/DeviceJobStatusIndicator */ "./resources/js/components/DeviceJobStatusIndicator/DeviceJobStatusIndicator.js");
/* harmony import */ var _deviceJobsDataTable_css__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ./deviceJobsDataTable.css */ "./resources/js/components/DeviceJobsDataTable/deviceJobsDataTable.css");
...
var DeviceJobsDataTable = function DeviceJobsDataTable(_ref) {
  var history = _ref.history,
      hideActionsBar = _ref.hideActionsBar,
      selectedDeviceJobs = _ref.selectedDeviceJobs,
      setSelectedDeviceJobs = _ref.setSelectedDeviceJobs,
      deviceJobs = _ref.deviceJobs,
      deviceJobsTotalRecords = _ref.deviceJobsTotalRecords,
      isFetchingDeviceJobs = _ref.isFetchingDeviceJobs,
      fetchDeviceJobsErrorMessage = _ref.fetchDeviceJobsErrorMessage,
      fetchDeviceJobsLazyParams = _ref.fetchDeviceJobsLazyParams,
      isDeletingDeviceJobs = _ref.isDeletingDeviceJobs,
      deleteDeviceJobsErrorMessage = _ref.deleteDeviceJobsErrorMessage,
      fetchDeviceJobsStartAsync = _ref.fetchDeviceJobsStartAsync,
      setFetchDeviceJobsLazyParams = _ref.setFetchDeviceJobsLazyParams,
      resetFetchDeviceJobsLazyParams = _ref.resetFetchDeviceJobsLazyParams,
      deleteDeviceJobsStartAsync = _ref.deleteDeviceJobsStartAsync;
  ...
  var _useState3 = (0,react__WEBPACK_IMPORTED_MODULE_0__.useState)(null),
      ...
      deviceJob = _useState4[0],
      setDeviceJob = _useState4[1];
  ...
  var _useState7 = (0,react__WEBPACK_IMPORTED_MODULE_0__.useState)(null),
      ...
      startedAtFilter = _useState8[0],
      setStartedAtFilter = _useState8[1];

  var _useState9 = (0,react__WEBPACK_IMPORTED_MODULE_0__.useState)(null),
      _useState10 = _slicedToArray(_useState9, 2),
      completedAtFilter = _useState10[0],
      setCompletedAtFilter = _useState10[1];
  ...
  (0,react__WEBPACK_IMPORTED_MODULE_0__.useEffect)(function () {
    return resetFetchDeviceJobsLazyParams;
  }, []);
  ...
  var confirmDeleteDeviceJob = function confirmDeleteDeviceJob(deviceJob) {
  ...
  var onPage = function onPage(event) {
    var _lazyParams = _objectSpread(_objectSpread({}, fetchDeviceJobsLazyParams), event);
  ...
  var header = /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_12__.jsx)(_components_DataTableHeader_DataTableHeader__WEBPACK_IMPORTED_MODULE_7__.default, {
    headerName: "Device Jobs",
    onSearchInputChange: function onSearchInputChange(e) {
      return setGlobalFilter(e.target.value);
    }
  });

  var renderStatusFilter = function renderStatusFilter() {
    return /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_12__.jsx)(primereact_dropdown__WEBPACK_IMPORTED_MODULE_4__.Dropdown, {
      value: statusFilter,
  ...
  var onStatusFilterChange = function onStatusFilterChange(event) {
  ...
  var statusItemTemplate = function statusItemTemplate(option) {
    return /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_12__.jsx)(_DeviceJobStatusIndicator_DeviceJobStatusIndicator__WEBPACK_IMPORTED_MODULE_10__.default, {
      status: option.value
    });
  };

  var renderStartedAtFilter = function renderStartedAtFilter() {
    return /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_12__.jsx)(_DataTableDateRangeFilter_DataTableDateRangeFilter__WEBPACK_IMPORTED_MODULE_8__.default, {
      value: startedAtFilter,
      setValueCallback: setStartedAtFilter,
      dataTable: dt,
  ...
  var renderCompletedAtFilter = function renderCompletedAtFilter() {
    return /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_12__.jsx)(_DataTableDateRangeFilter_DataTableDateRangeFilter__WEBPACK_IMPORTED_MODULE_8__.default, {
      value: completedAtFilter,
      setValueCallback: setCompletedAtFilter,
      dataTable: dt,
  ...
  var uniqueIdColumnBody = function uniqueIdColumnBody(rowData) {
  ...
  var nameColumnBody = function nameColumnBody(rowData) {
    return /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_12__.jsxs)(react_jsx_runtime__WEBPACK_IMPORTED_MODULE_12__.Fragment, {
      children: [/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_12__.jsx)("span", {
        className: "p-column-title",
        children: "Name"
  ...
  var deviceGroupNameColumnBody = function deviceGroupNameColumnBody(rowData) {
    return /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_12__.jsxs)(react_jsx_runtime__WEBPACK_IMPORTED_MODULE_12__.Fragment, {
      children: [/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_12__.jsx)("span", {
        className: "p-column-title",
  ...
  var statusColumnBody = function statusColumnBody(rowData) {
    return /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_12__.jsxs)(react_jsx_runtime__WEBPACK_IMPORTED_MODULE_12__.Fragment, {
      children: [/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_12__.jsx)("span", {
        className: "p-column-title",
        children: "Status"
  ...
  var startedAtColumnBody = function startedAtColumnBody(rowData) {
    return /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_12__.jsxs)(react_jsx_runtime__WEBPACK_IMPORTED_MODULE_12__.Fragment, {
      children: [/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_12__.jsx)("span", {
        className: "p-column-title",
        children: "Started at"
      }), (0,_utils_utils__WEBPACK_IMPORTED_MODULE_5__.formatDateTimeISOStringToCommonString)(rowData.started_at)]
    });
  };

  var completedAtColumnBody = function completedAtColumnBody(rowData) {
    return /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_12__.jsxs)(react_jsx_runtime__WEBPACK_IMPORTED_MODULE_12__.Fragment, {
      children: [/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_12__.jsx)("span", {
        className: "p-column-title",
        children: "Completed at"
      }), (0,_utils_utils__WEBPACK_IMPORTED_MODULE_5__.formatDateTimeISOStringToCommonString)(rowData.completed_at)]
    });
  };

  var actionColumnBody = function actionColumnBody(rowData) {
    return /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_12__.jsxs)(react_jsx_runtime__WEBPACK_IMPORTED_MODULE_12__.Fragment, {
      children: [/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_12__.jsx)(primereact_button__WEBPACK_IMPORTED_MODULE_3__.Button, {
        icon: "pi pi-search",
        className: "p-button-rounded p-button-success mr-2",
        onClick: function onClick() {
          return history.push("/device/jobs/".concat(rowData.unique_id));
        }
      }), /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_12__.jsx)(primereact_button__WEBPACK_IMPORTED_MODULE_3__.Button, {
        icon: "pi pi-trash",
        className: "p-button-rounded p-button-danger mr-2",
        onClick: function onClick() {
          return confirmDeleteDeviceJob(rowData);
        }
      })]
    });
  };

  var statusFilterElement = renderStatusFilter();
  var startedAtFilterElement = renderStartedAtFilter();
  var completedFilterElement = renderCompletedAtFilter();
  return /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_12__.jsxs)(react_jsx_runtime__WEBPACK_IMPORTED_MODULE_12__.Fragment, {
    children: [/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_12__.jsx)("div", {
      className: "datatable-devices-jobs",
      children: /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_12__.jsxs)(primereact_datatable__WEBPACK_IMPORTED_MODULE_1__.DataTable, _objectSpread(_objectSpread(_objectSpread({
        ref: dt,
        value: deviceJobs,
        ...
        lazy: true,
        header: header,
        className: "p-datatable-devices-jobs",
        dataKey: "id",
        rowHover: true,
        globalFilter: globalFilter
      }, selectedDeviceJobs !== undefined && {
        selection: selectedDeviceJobs
      }), setSelectedDeviceJobs !== undefined && {
        onSelectionChange: function onSelectionChange(e) {
          return setSelectedDeviceJobs(e.value);
        }
      }), {}, {
        paginator: true,
        emptyMessage: "No device job found",
        currentPageReportTemplate: "Showing {first} to {last} of {totalRecords} entries",
        paginatorTemplate: "FirstPageLink PrevPageLink PageLinks NextPageLink LastPageLink CurrentPageReport RowsPerPageDropdown",
        rowsPerPageOptions: [10, 50, 100, 200],
        first: fetchDeviceJobsLazyParams.first,
        rows: fetchDeviceJobsLazyParams.rows,
        totalRecords: deviceJobsTotalRecords,
        onPage: onPage,
        onSort: onSort,
        sortField: fetchDeviceJobsLazyParams.sortField,
        sortOrder: fetchDeviceJobsLazyParams.sortOrder,
        onFilter: onFilter,
        filters: fetchDeviceJobsLazyParams.filters,
        filterDelay: 800,
        loading: isFetchingDeviceJobs,
        children: [selectedDeviceJobs !== undefined && setSelectedDeviceJobs !== undefined && /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_12__.jsx)(primereact_column__WEBPACK_IMPORTED_MODULE_2__.Column, {
          ...
          field: "unique_id",
          header: "Device job ID",
          body: uniqueIdColumnBody,
          sortable: true,
          filter: true,
          filterPlaceholder: "Search by device job ID"
        }), /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_12__.jsx)(primereact_column__WEBPACK_IMPORTED_MODULE_2__.Column, {
          field: "name",
          header: "Device job name",
          body: nameColumnBody,
          sortable: true,
          filter: true,
          ...
          header: "Device group",
          body: deviceGroupNameColumnBody,
          sortable: true,
          filter: true,
          filterPlaceholder: "Search by device group"
        }), /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_12__.jsx)(primereact_column__WEBPACK_IMPORTED_MODULE_2__.Column, {
          field: "saved_command_name",
          header: "Saved command",
          ...
          field: "started_at",
          header: "Started at",
          body: startedAtColumnBody,
          sortable: true,
          filter: true,
          excludeGlobalFilter: true,
          filterElement: startedAtFilterElement
        }), /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_12__.jsx)(primereact_column__WEBPACK_IMPORTED_MODULE_2__.Column, {
          field: "completed_at",
          header: "Completed at",
          body: completedAtColumnBody,
          sortable: true,
          filter: true,
          excludeGlobalFilter: true,
          filterElement: completedFilterElement
        }), !hideActionsBar && /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_12__.jsx)(primereact_column__WEBPACK_IMPORTED_MODULE_2__.Column, {
    ...
    }), !hideActionsBar && showDeleteDeviceJobModal && /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_12__.jsx)(_DeleteDeviceJobModal_DeleteDeviceJobModal__WEBPACK_IMPORTED_MODULE_9__.default, {
      deviceJob: deviceJob,
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ((0,react_router_dom__WEBPACK_IMPORTED_MODULE_13__.withRouter)(DeviceJobsDataTable));
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "fetchDeviceJobsStart": () => (/* binding */ fetchDeviceJobsStart),
/* harmony export */   "fetchDeviceJobsSuccess": () => (/* binding */ fetchDeviceJobsSuccess),
/* harmony export */   "fetchDeviceJobsFailure": () => (/* binding */ fetchDeviceJobsFailure),
/* harmony export */   "fetchDeviceJobsStartAsync": () => (/* binding */ fetchDeviceJobsStartAsync),
/* harmony export */   "setFetchDeviceJobsLazyParams": () => (/* binding */ setFetchDeviceJobsLazyParams),
/* harmony export */   "resetFetchDeviceJobsLazyParams": () => (/* binding */ resetFetchDeviceJobsLazyParams),
/* harmony export */   "createDeviceJobStart": () => (/* binding */ createDeviceJobStart),
/* harmony export */   "createDeviceJobSuccess": () => (/* binding */ createDeviceJobSuccess),
/* harmony export */   "createDeviceJobFailure": () => (/* binding */ createDeviceJobFailure),
/* harmony export */   "createDeviceJobStartAsync": () => (/* binding */ createDeviceJobStartAsync),
/* harmony export */   "fetchDeviceJobStart": () => (/* binding */ fetchDeviceJobStart),
/* harmony export */   "fetchDeviceJobSuccess": () => (/* binding */ fetchDeviceJobSuccess),
/* harmony export */   "fetchDeviceJobFailure": () => (/* binding */ fetchDeviceJobFailure),
/* harmony export */   "fetchDeviceJobStartAsync": () => (/* binding */ fetchDeviceJobStartAsync),
/* harmony export */   "updateDeviceJobStart": () => (/* binding */ updateDeviceJobStart),
/* harmony export */   "updateDeviceJobSuccess": () => (/* binding */ updateDeviceJobSuccess),
/* harmony export */   "updateDeviceJobFailure": () => (/* binding */ updateDeviceJobFailure),
/* harmony export */   "updateDeviceJobStartAsync": () => (/* binding */ updateDeviceJobStartAsync),
/* harmony export */   "deleteDeviceJobsStart": () => (/* binding */ deleteDeviceJobsStart),
/* harmony export */   "deleteDeviceJobsSuccess": () => (/* binding */ deleteDeviceJobsSuccess),
/* harmony export */   "deleteDeviceJobsFailure": () => (/* binding */ deleteDeviceJobsFailure),
/* harmony export */   "deleteDeviceJobsStartAsync": () => (/* binding */ deleteDeviceJobsStartAsync),
/* harmony export */   "pollFetchDeviceJobStartAsync": () => (/* binding */ pollFetchDeviceJobStartAsync),
/* harmony export */   "pollFetchDeviceJobStop": () => (/* binding */ pollFetchDeviceJobStop)
/* harmony export */ });
...
var fetchDeviceJobsStart = function fetchDeviceJobsStart() {
  return {
    type: _deviceJob_types__WEBPACK_IMPORTED_MODULE_1__.default.FETCH_DEVICE_JOBS_START
  };
};
var fetchDeviceJobsSuccess = function fetchDeviceJobsSuccess(deviceJobs) {
  return {
    type: _deviceJob_types__WEBPACK_IMPORTED_MODULE_1__.default.FETCH_DEVICE_JOBS_SUCCESS,
    payload: deviceJobs
  };
};
var fetchDeviceJobsFailure = function fetchDeviceJobsFailure(errorMessage) {
  return {
    type: _deviceJob_types__WEBPACK_IMPORTED_MODULE_1__.default.FETCH_DEVICE_JOBS_FAILURE,
    payload: errorMessage
  };
};
var fetchDeviceJobsStartAsync = function fetchDeviceJobsStartAsync(lazyParams) {
  return function (dispatch) {
    dispatch(fetchDeviceJobsStart());
    axios.get("".concat(_data_config__WEBPACK_IMPORTED_MODULE_2__.API_ENDPOINT, "/device/jobs"), {
      params: lazyParams
...
var setFetchDeviceJobsLazyParams = function setFetchDeviceJobsLazyParams(lazyParams) {
  return {
    type: _deviceJob_types__WEBPACK_IMPORTED_MODULE_1__.default.SET_FETCH_DEVICE_JOBS_LAZY_PARAMS,
    payload: lazyParams
  };
};
var resetFetchDeviceJobsLazyParams = function resetFetchDeviceJobsLazyParams() {
  return {
    type: _deviceJob_types__WEBPACK_IMPORTED_MODULE_1__.default.RESET_FETCH_DEVICE_JOBS_LAZY_PARAMS
  };
}; // Create

var createDeviceJobStart = function createDeviceJobStart() {
  return {
    type: _deviceJob_types__WEBPACK_IMPORTED_MODULE_1__.default.CREATE_DEVICE_JOB_START
  };
};
var createDeviceJobSuccess = function createDeviceJobSuccess() {
  return {
    type: _deviceJob_types__WEBPACK_IMPORTED_MODULE_1__.default.CREATE_DEVICE_JOB_SUCCESS
  };
};
var createDeviceJobFailure = function createDeviceJobFailure(errorMessage) {
  return {
    type: _deviceJob_types__WEBPACK_IMPORTED_MODULE_1__.default.CREATE_DEVICE_JOB_FAILURE,
    payload: errorMessage
  };
};
var createDeviceJobStartAsync = function createDeviceJobStartAsync(data, history) {
  return function (dispatch) {
    dispatch(createDeviceJobStart());
    var toastId = _utils_utils__WEBPACK_IMPORTED_MODULE_3__.toastHelper.loading('Creating device job');
    axios.post("".concat(_data_config__WEBPACK_IMPORTED_MODULE_2__.API_ENDPOINT, "/device/jobs"), data).then(function (result) {
      dispatch(createDeviceJobSuccess());
      _utils_utils__WEBPACK_IMPORTED_MODULE_3__.toastHelper.success('Device job created successfully!', toastId);
      (0,_utils_utils__WEBPACK_IMPORTED_MODULE_3__.redirectToAfterToastSuccess)(history, "/device/jobs/".concat(result.data.result.deviceJob.unique_id));
    })["catch"](function (error) {
      dispatch(createDeviceJobFailure(error.message));
      _utils_utils__WEBPACK_IMPORTED_MODULE_3__.toastHelper.error("Failed to create device job: ".concat(error.message), toastId);
    });
  };
}; // Read

var fetchDeviceJobStart = function fetchDeviceJobStart() {
  return {
    type: _deviceJob_types__WEBPACK_IMPORTED_MODULE_1__.default.FETCH_DEVICE_JOB_START
  };
};
var fetchDeviceJobSuccess = function fetchDeviceJobSuccess(deviceJob) {
  return {
    type: _deviceJob_types__WEBPACK_IMPORTED_MODULE_1__.default.FETCH_DEVICE_JOB_SUCCESS,
    payload: deviceJob
  };
};
var fetchDeviceJobFailure = function fetchDeviceJobFailure(errorMessage) {
  return {
    type: _deviceJob_types__WEBPACK_IMPORTED_MODULE_1__.default.FETCH_DEVICE_JOB_FAILURE,
    payload: errorMessage
  };
};
var fetchDeviceJobStartAsync = function fetchDeviceJobStartAsync(id) {
  return function (dispatch, getState) {
    dispatch(fetchDeviceJobStart());
    axios.get("".concat(_data_config__WEBPACK_IMPORTED_MODULE_2__.API_ENDPOINT, "/device/jobs/").concat(id)).then(function (result) {
...
var updateDeviceJobStart = function updateDeviceJobStart() {
  return {
    type: _deviceJob_types__WEBPACK_IMPORTED_MODULE_1__.default.UPDATE_DEVICE_JOB_START
  };
};
var updateDeviceJobSuccess = function updateDeviceJobSuccess(deviceJob) {
  return {
    type: _deviceJob_types__WEBPACK_IMPORTED_MODULE_1__.default.UPDATE_DEVICE_JOB_SUCCESS,
    payload: deviceJob
  };
};
var updateDeviceJobFailure = function updateDeviceJobFailure(errorMessage) {
  return {
    type: _deviceJob_types__WEBPACK_IMPORTED_MODULE_1__.default.UPDATE_DEVICE_JOB_FAILURE,
    payload: errorMessage
  };
};
var updateDeviceJobStartAsync = function updateDeviceJobStartAsync(id, data, history) {
  return function (dispatch) {
    dispatch(updateDeviceJobStart());
    var toastId = _utils_utils__WEBPACK_IMPORTED_MODULE_3__.toastHelper.loading('Updating deviceJob');
    axios.patch("".concat(_data_config__WEBPACK_IMPORTED_MODULE_2__.API_ENDPOINT, "/device/jobs/").concat(id), data).then(function (result) {
      dispatch(updateDeviceJobSuccess(result.data.result.deviceJob));
      _utils_utils__WEBPACK_IMPORTED_MODULE_3__.toastHelper.success('DeviceJob updated successfully!', toastId);

      if (history) {
        (0,_utils_utils__WEBPACK_IMPORTED_MODULE_3__.redirectToAfterToastSuccess)(history, '/device/jobs');
      }
    })["catch"](function (error) {
      dispatch(updateDeviceJobFailure(error.message));
      _utils_utils__WEBPACK_IMPORTED_MODULE_3__.toastHelper.error("Device job update failed: ".concat(error.message), toastId);
    });
  };
}; // Delete Mass

var deleteDeviceJobsStart = function deleteDeviceJobsStart() {
  return {
    type: _deviceJob_types__WEBPACK_IMPORTED_MODULE_1__.default.DELETE_DEVICE_JOBS_START
  };
};
var deleteDeviceJobsSuccess = function deleteDeviceJobsSuccess() {
  return {
    type: _deviceJob_types__WEBPACK_IMPORTED_MODULE_1__.default.DELETE_DEVICE_JOBS_SUCCESS
  };
};
var deleteDeviceJobsFailure = function deleteDeviceJobsFailure(errorMessage) {
  return {
    type: _deviceJob_types__WEBPACK_IMPORTED_MODULE_1__.default.DELETE_DEVICE_JOBS_FAILURE,
    payload: errorMessage
  };
};
var deleteDeviceJobsStartAsync = function deleteDeviceJobsStartAsync(ids, history) {
  return function (dispatch, getState) {
    dispatch(deleteDeviceJobsStart());
    var toastId = _utils_utils__WEBPACK_IMPORTED_MODULE_3__.toastHelper.loading("Deleting device ".concat(pluralize__WEBPACK_IMPORTED_MODULE_0___default()('job', ids.length)));
    axios["delete"]("".concat(_data_config__WEBPACK_IMPORTED_MODULE_2__.API_ENDPOINT, "/device/jobs"), {
      data: {
        ids: ids
      }
    }).then(function (result) {
      dispatch(deleteDeviceJobsSuccess());
      _utils_utils__WEBPACK_IMPORTED_MODULE_3__.toastHelper.success("Device ".concat(pluralize__WEBPACK_IMPORTED_MODULE_0___default()('job', ids.length), " deleted successfully!"), toastId);
      ...
      _utils_utils__WEBPACK_IMPORTED_MODULE_3__.toastHelper.error("Device ".concat(pluralize__WEBPACK_IMPORTED_MODULE_0___default()('job', ids.length), " delete failed: ").concat(error.message), toastId);
    });
  };
}; // Poll device job

var pollFetchDeviceJobStartAsync = function pollFetchDeviceJobStartAsync(id) {
  var interval = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : _data_config__WEBPACK_IMPORTED_MODULE_2__.DATA_POLLING_INTERVAL_IN_MS;
  return function (dispatch) {
    dispatch(fetchDeviceJobStartAsync(id));

    var fetch = function fetch() {
      return dispatch(fetchDeviceJobStartAsync(id));
    };

    dispatch({
      type: _deviceJob_types__WEBPACK_IMPORTED_MODULE_1__.default.POLL_FETCH_DEVICE_JOB_START,
      fetch: fetch,
      interval: interval
    });
  };
};
var pollFetchDeviceJobStop = function pollFetchDeviceJobStop() {
  return {
    type: _deviceJob_types__WEBPACK_IMPORTED_MODULE_1__.default.POLL_FETCH_DEVICE_JOB_STOP
  };
};
...
/***/ "./resources/js/views/deviceJobs/ListDeviceJobs.js":
/*!*********************************************************!*\
  !*** ./resources/js/views/deviceJobs/ListDeviceJobs.js ***!
  \*********************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony import */ var _redux_deviceJob_deviceJob_actions__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ../../redux/deviceJob/deviceJob.actions */ "./resources/js/redux/deviceJob/deviceJob.actions.js");
/* harmony import */ var _components_DeviceJobsDataTable_DeviceJobsDataTable__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ../../components/DeviceJobsDataTable/DeviceJobsDataTable */ "./resources/js/components/DeviceJobsDataTable/DeviceJobsDataTable.js");
/* harmony import */ var _components_DeleteDeviceJobsModal_DeleteDeviceJobsModal__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ../../components/DeleteDeviceJobsModal/DeleteDeviceJobsModal */ "./resources/js/components/DeleteDeviceJobsModal/DeleteDeviceJobsModal.js");
...
var ListDeviceJobs = function ListDeviceJobs(_ref) {
  var history = _ref.history,
      match = _ref.match,
      deviceJobs = _ref.deviceJobs,
      deviceJobsTotalRecords = _ref.deviceJobsTotalRecords,
  ...
  var _useState = (0,react__WEBPACK_IMPORTED_MODULE_0__.useState)(false),
      _useState2 = _slicedToArray(_useState, 2),
      showDeleteDeviceJobsModal = _useState2[0],
      setShowDeleteDeviceJobsModal = _useState2[1];

  var _useState3 = (0,react__WEBPACK_IMPORTED_MODULE_0__.useState)(null),
      _useState4 = _slicedToArray(_useState3, 2),
      selectedDeviceJobs = _useState4[0],
      setSelectedDeviceJobs = _useState4[1];

  var confirmDeleteSelectedDeviceJobs = function confirmDeleteSelectedDeviceJobs() {
    setShowDeleteDeviceJobsModal(!showDeleteDeviceJobsModal);
  };

  var deleteSelectedDeviceJobs = function deleteSelectedDeviceJobs() {
    var selectedDeviceJobIds = selectedDeviceJobs.map(function (selectedDeviceJob) {
      return selectedDeviceJob.id;
    });
  ...
  var leftToolbar = function leftToolbar() {
    return /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_9__.jsxs)(react_jsx_runtime__WEBPACK_IMPORTED_MODULE_9__.Fragment, {
      ...
      }), /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_9__.jsx)(primereact_button__WEBPACK_IMPORTED_MODULE_5__.Button, {
        label: "Delete",
        icon: "pi pi-trash",
  ...
  return /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_9__.jsxs)(react_jsx_runtime__WEBPACK_IMPORTED_MODULE_9__.Fragment, {
        ...
        children: /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_9__.jsxs)(_coreui_react__WEBPACK_IMPORTED_MODULE_3__.CCard, {
          children: [/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_9__.jsx)(_coreui_react__WEBPACK_IMPORTED_MODULE_3__.CCardHeader, {
            ...
            children: [/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_9__.jsx)(primereact_toolbar__WEBPACK_IMPORTED_MODULE_4__.Toolbar, {
              className: "mb-4",
              left: leftToolbar
            }), /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_9__.jsx)(_components_DeviceJobsDataTable_DeviceJobsDataTable__WEBPACK_IMPORTED_MODULE_7__.default, {
              selectedDeviceJobs: selectedDeviceJobs,
    ...
    }), showDeleteDeviceJobsModal && /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_9__.jsx)(_components_DeleteDeviceJobsModal_DeleteDeviceJobsModal__WEBPACK_IMPORTED_MODULE_8__.default, {
      show: showDeleteDeviceJobsModal,
      onClose: function onClose() {
        return setShowDeleteDeviceJobsModal(!showDeleteDeviceJobsModal);
      },
...
var mapDispatchToProps = function mapDispatchToProps(dispatch) {
  return {
    fetchDeviceJobsStartAsync: function fetchDeviceJobsStartAsync(lazyParams) {
      return dispatch((0,_redux_deviceJob_deviceJob_actions__WEBPACK_IMPORTED_MODULE_6__.fetchDeviceJobsStartAsync)(lazyParams));
    },
    setFetchDeviceJobsLazyParams: function setFetchDeviceJobsLazyParams(lazyParams) {
      return dispatch((0,_redux_deviceJob_deviceJob_actions__WEBPACK_IMPORTED_MODULE_6__.setFetchDeviceJobsLazyParams)(lazyParams));
    },
    resetFetchDeviceJobsLazyParams: function resetFetchDeviceJobsLazyParams() {
      return dispatch((0,_redux_deviceJob_deviceJob_actions__WEBPACK_IMPORTED_MODULE_6__.resetFetchDeviceJobsLazyParams)());
    },
    deleteDeviceJobsStartAsync: function deleteDeviceJobsStartAsync(ids, history) {
      return dispatch((0,_redux_deviceJob_deviceJob_actions__WEBPACK_IMPORTED_MODULE_6__.deleteDeviceJobsStartAsync)(ids, history));
    }
  };
};

/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ((0,react_redux__WEBPACK_IMPORTED_MODULE_1__.connect)(mapStateToProps, mapDispatchToProps)(ListDeviceJobs));

/***/ }),

/***/ "./node_modules/css-loader/dist/cjs.js??ruleSet[1].rules[6].oneOf[1].use[1]!./node_modules/postcss-loader/dist/cjs.js??ruleSet[1].rules[6].oneOf[1].use[2]!./resources/js/components/DeviceJobsDataTable/deviceJobsDataTable.css":
/*!***************************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/css-loader/dist/cjs.js??ruleSet[1].rules[6].oneOf[1].use[1]!./node_modules/postcss-loader/dist/cjs.js??ruleSet[1].rules[6].oneOf[1].use[2]!./resources/js/components/DeviceJobsDataTable/deviceJobsDataTable.css ***!
  \***************************************************************************************************************************************************************************************************************************************/
...
// Module
___CSS_LOADER_EXPORT___.push([module.id, "@-webkit-keyframes pulse {\r\n    0% {\r\n        background-color: rgba(165, 165, 165, 0.1)\r\n    }\r\n    50% {\r\n        background-color: rgba(165, 165, 165, 0.3)\r\n    }\r\n    100% {\r\n        background-color: rgba(165, 165, 165, 0.1)\r\n    }\r\n}\r\n\r\n@keyframes pulse {\r\n    0% {\r\n        background-color: rgba(165, 165, 165, 0.1)\r\n    }\r\n    50% {\r\n        background-color: rgba(165, 165, 165, 0.3)\r\n    }\r\n    100% {\r\n        background-color: rgba(165, 165, 165, 0.1)\r\n    }\r\n}\r\n\r\n.datatable-devices-jobs *:not(.table-header) {\r\n    font-size: 14px;\r\n}\r\n\r\n.datatable-devices-jobs .p-paginator .p-paginator-current {\r\n    margin-left: auto;\r\n}\r\n\r\n.datatable-devices-jobs .p-progressbar {\r\n    height: .5rem;\r\n    background-color: #D8DADC;\r\n}\r\n\r\n.datatable-devices-jobs .p-progressbar .p-progressbar-value {\r\n    background-color: #607D8B;\r\n}\r\n\r\n.datatable-devices-jobs .table-header {\r\n    display: flex;\r\n    justify-content: space-between;\r\n}\r\n\r\n.datatable-devices-jobs .p-datepicker {\r\n    min-width: 25rem;\r\n}\r\n\r\n.datatable-devices-jobs .p-datepicker td {\r\n    font-weight: 400;\r\n}\r\n\r\n.datatable-devices-jobs .p-datatable.p-datatable-devices-jobs .p-datatable-header {\r\n    padding: 1rem;\r\n    text-align: left;\r\n    font-size: 1.5em;\r\n}\r\n\r\n.datatable-devices-jobs .p-datatable.p-datatable-devices-jobs .p-paginator {\r\n    padding: 1rem;\r\n}\r\n\r\n.datatable-devices-jobs .p-datatable.p-datatable-devices-jobs .p-datatable-thead > tr > th {\r\n    text-align: left;\r\n}\r\n\r\n.datatable-devices-jobs .p-datatable.p-datatable-devices-jobs .p-datatable-tbody > tr > td:not([colspan]) {\r\n    cursor: auto;\r\n    text-overflow: ellipsis;\r\n    white-space: nowrap;\r\n    overflow: hidden;\r\n}\r\n\r\n.datatable-devices-jobs .p-datatable.p-datatable-devices-jobs .p-dropdown-label:not(.p-placeholder) {\r\n    text-transform: uppercase;\r\n}\r\n\r\n.datatable-devices-jobs .p-datatable-devices-jobs .p-datatable-tbody > tr > td .p-column-title {\r\n    display: none;\r\n}\r\n\r\n@media screen and (max-width: 960px) {\r\n    .datatable-devices-jobs .p-datatable.p-datatable-devices-jobs .p-datatable-thead > tr > th,\r\n    .datatable-devices-jobs .p-datatable.p-datatable-devices-jobs .p-datatable-tfoot > tr > td {\r\n        display: none !important;\r\n    }\r\n\r\n    .datatable-devices-jobs .p-datatable.p-datatable-devices-jobs .p-datatable-tbody > tr {\r\n        border-bottom: 1px solid var(--layer-2);\r\n    }\r\n\r\n    .datatable-devices-jobs .p-datatable.p-datatable-devices-jobs .p-datatable-tbody > tr > td {\r\n        text-align: left;\r\n        display: block;\r\n        border: 0 none !important;\r\n        width: 100% !important;\r\n        float: left;\r\n        clear: left;\r\n    }\r\n\r\n    .datatable-devices-jobs .p-datatable.p-datatable-devices-jobs .p-datatable-tbody > tr > td .p-column-title {\r\n        padding: .4rem;\r\n        min-width: 30%;\r\n        display: inline-block;\r\n        margin: -.4rem 1rem -.4rem -.4rem;\r\n        font-weight: bold;\r\n    }\r\n\r\n    .datatable-devices-jobs .p-datatable.p-datatable-devices-jobs .p-datatable-tbody > tr > td .p-progressbar {\r\n        margin-top: .5rem;\r\n    }\r\n}\r\n\r\n.p-column-filter {\r\n    width: 100%;\r\n}", ""]);
// Exports
...
/***/ "./node_modules/primereact/components/api/Locale.js":
/*!**********************************************************!*\
  !*** ./node_modules/primereact/components/api/Locale.js ***!
  \**********************************************************/
...
var _PrimeReact = _interopRequireDefault(__webpack_require__(/*! ./PrimeReact */ "./node_modules/primereact/components/api/PrimeReact.js"));
...
var _Locale = __webpack_require__(/*! ../api/Locale */ "./node_modules/primereact/components/api/Locale.js");
...
var _Mask = __webpack_require__(/*! ../utils/Mask */ "./node_modules/primereact/components/utils/Mask.js");
...
/***/ "./node_modules/primereact/components/utils/Mask.js":
/*!**********************************************************!*\
  !*** ./node_modules/primereact/components/utils/Mask.js ***!
  \**********************************************************/
/***/ ((__unused_webpack_module, exports, __webpack_require__) => {
...
/***/ "./resources/js/components/DeviceJobsDataTable/deviceJobsDataTable.css":
/*!*****************************************************************************!*\
  !*** ./resources/js/components/DeviceJobsDataTable/deviceJobsDataTable.css ***!
  \*****************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony import */ var _node_modules_css_loader_dist_cjs_js_ruleSet_1_rules_6_oneOf_1_use_1_node_modules_postcss_loader_dist_cjs_js_ruleSet_1_rules_6_oneOf_1_use_2_deviceJobsDataTable_css__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! !!../../../../node_modules/css-loader/dist/cjs.js??ruleSet[1].rules[6].oneOf[1].use[1]!../../../../node_modules/postcss-loader/dist/cjs.js??ruleSet[1].rules[6].oneOf[1].use[2]!./deviceJobsDataTable.css */ "./node_modules/css-loader/dist/cjs.js??ruleSet[1].rules[6].oneOf[1].use[1]!./node_modules/postcss-loader/dist/cjs.js??ruleSet[1].rules[6].oneOf[1].use[2]!./resources/js/components/DeviceJobsDataTable/deviceJobsDataTable.css");
...
var update = _node_modules_style_loader_dist_runtime_injectStylesIntoStyleTag_js__WEBPACK_IMPORTED_MODULE_0___default()(_node_modules_css_loader_dist_cjs_js_ruleSet_1_rules_6_oneOf_1_use_1_node_modules_postcss_loader_dist_cjs_js_ruleSet_1_rules_6_oneOf_1_use_2_deviceJobsDataTable_css__WEBPACK_IMPORTED_MODULE_1__.default, options);



/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (_node_modules_css_loader_dist_cjs_js_ruleSet_1_rules_6_oneOf_1_use_1_node_modules_postcss_loader_dist_cjs_js_ruleSet_1_rules_6_oneOf_1_use_2_deviceJobsDataTable_css__WEBPACK_IMPORTED_MODULE_1__.default.locals || {});
